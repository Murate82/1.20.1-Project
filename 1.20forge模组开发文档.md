...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS=							//延迟注册物品
            DeferredRegister.create(ForgeRegistries.ITEMS, Tutorialmod.MOD_ID); //注册物品，模组ID

    public static  void register(IEventBus eventBus){ //事件总线，用于注册和处理
        ITEMS.register(eventBus);//将物品注册指定到总线中
    }
}
```

**在Tutorialmod.java下添加**

![image-20240311190044451](./image/image-20240311190044451.png)
...
![image-20240311233044148](../../AppData/Roaming/Typora/typora-user-images/image-20240311233044148.png)

**回到Tutorialmod类**

![image-20240311232923385](image/image-20240311232923385.png)
